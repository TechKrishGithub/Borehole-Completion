...
import StepTestRecTable from './StepTestRecTable';
  ...
  const handleHidePickerOff = () => {
    ...
    return(
       <ScrollView>
        ...
        <Text style={{fontSize:20,fontWeight:'bold'}}>STEP TEST RECOVERY</Text>
        </View>
        <Text></Text>
      ...
      />
        ...
        <StepTestRecTable getBoreHoleNum={getBoreHoleNum} duraPumpTest={duraPumpTest} statWatLeve={statWatLeve} dynWatLeve={dynWatLeve} mesPoint={mesPoint} pumInstDep={pumInstDep} mesBy={mesBy} pumpOndate={pumpOndate} pumpOffdate={pumpOffdate}/>
        </View>
        </ScrollView>
...
export default StepTestRecovery;